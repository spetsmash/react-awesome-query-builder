...
var setValue = function setValue(state, path, delta, value, valueType, flag, config, __isInternal) {
  var fieldSeparator = config.settings.fieldSeparator;
  ...
  return function () {
    ...
    switch (action.type) {
      ...
      case constants.SET_VALUE:
        var set = {};
        var tree = setValue(state.tree, action.path, action.delta, action.value, action.valueType, action.flag, action.config, action.__isInternal);
