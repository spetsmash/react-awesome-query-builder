...
var _default = function _default(Rule) {
  var RuleContainer = /*#__PURE__*/function (_Component) {
    ...
    function RuleContainer(props) {
      ...
      _this.setValue = function (delta, value, flag, touched, type, __isInternal) {
        _this.props.actions.setValue(_this.props.path, delta, value, type, flag, touched, __isInternal);
      };
