...
var _default = function _default(Widget) {
  ...
  return _temp = _class = /*#__PURE__*/function (_PureComponent) {
    ...
    function WidgetContainer(props) {
      ...
      _this._setValue = function (isSpecialRange, delta, widgetType, value, flag, touched, __isInternal) {
        if (isSpecialRange && Array.isArray(value)) {
          var oldRange = [_this.props.value.get(0), _this.props.value.get(1)];
          if (oldRange[0] != value[0]) _this.props.setValue(0, value[0], flag, touched, widgetType, __isInternal);
          if (oldRange[1] != value[1]) _this.props.setValue(1, value[1], flag, touched, widgetType, __isInternal);
        } else {
          _this.props.setValue(delta, value, flag, touched, widgetType, __isInternal);
        }
      };
