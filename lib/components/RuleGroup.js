...
var RuleGroup = (_dec = (0, _Draggable["default"])("group rule_group"), (0, _GroupContainer["default"])(_class = _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Group) {
  ...
  _createClass(RuleGroup, [{
    ...
    value: function errorMessageRequiredField(fields) {
      ...
      var label = config.fields[selectedField.split('.')[0]].subfields[selectedField.split('.')[1]].subfields.value.label;
      var index = newFields.indexOf('value');
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "icon-red"
      }), " Please add the required parameter(s):", /*#__PURE__*/_react["default"].createElement("span", null, " ", newFields.join(', '))));
    }
  }, {
    key: "ifRuleGroup",
