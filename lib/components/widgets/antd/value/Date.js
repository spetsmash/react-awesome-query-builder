  ...
  function DateWidget(props) {
    ...
    _this.handleChange = function (_value) {
      ...
      if (Array.isArray(_value)) {
        ...
        if (value || _value === null) setValue(value, false, true); // touched
      }
    };

    _this.disabledDate = function (current) {
      // Can not select days before today and today
      var restrictions = _this.props.restrictions;

      if (restrictions === 'financial') {
        return current && (current > (0, _moment["default"])().endOf('day') || current < (0, _moment["default"])().subtract(3, 'months'));
      }

      if (restrictions === 'personal') {
        return current && (current > (0, _moment["default"])().endOf('day') || current > (0, _moment["default"])().subtract(18, 'years'));
      }
