...
var _boolean2 = _interopRequireDefault(require("less/lib/less/functions/boolean"));
  ...
  function DateWidget(props) {
    ...
    _this.handleChange = function (_value) {
      ...
      if (Array.isArray(_value)) {
        ...
        var _value3 = _value && _value.isValid() ? _value.format(valueFormat) : undefined;

        if (_value3 || _value === null) setValue(_value3, false, true); // touched
      }
    };
    ...
    _this.onOpenChange = function (open) {
      ...
      if (value === undefined) {
        var date = (0, _moment["default"])((0, _moment["default"])().subtract(18, 'year').format('YYYY-MM-DD'));
        var _defaultPickerValue = date;
        setValue(date, false, true); // this.setState({defaultPickerValue: defaultPickerValue});
      }
    };
  ...
  _createClass(DateWidget, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          restrictions = _this$props3.restrictions,
          defaultPickerValue = _this$props3.defaultPickerValue;
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, operator === "date_range" || operator === "not_date_range" ? /*#__PURE__*/_react["default"].createElement(RangePicker, _extends({
        ...
        size: renderSize,
        format: dateFormat,
        onChange: this.handleChange // onOpenChange={this.onOpenRangeChange}
        ,
