...
var DateWidget = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(DateWidget, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, operator === "exists" || operator === "not_exists" ? null : operator === "date_range" || operator === "not_date_range" ? /*#__PURE__*/_react["default"].createElement(RangePicker, _extends({
        disabled: readonly,
        key: "widget-date",
        size: renderSize,
        format: dateFormat,
