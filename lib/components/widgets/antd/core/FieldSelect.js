  ...
  _createClass(FieldSelect, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          childrenSelected = _this$props.childrenSelected,
      ...
      var width = isFieldSelected && !showSearch ? null : selectWidth + _stuff.SELECT_WIDTH_OFFSET_RIGHT + _stuff.SELECT_WIDTH_ICON;
      var tooltipText = selectedAltLabel || selectedFullLabel;
      if (tooltipText == selectedLabel) tooltipText = null;
      var fieldSelectItems = this.renderSelectItems(items, childrenSelected);
      var res;

      if (placeholder && items && items.length === 1) {
        res = /*#__PURE__*/_react["default"].createElement("div", {
          className: "single-operator"
        }, /*#__PURE__*/_react["default"].createElement("span", null, selectedLabel));
      } else {
        res = /*#__PURE__*/_react["default"].createElement(_select["default"], _extends({
    ...
    value: function renderSelectItems(fields, childrenSelected) {
      var _this2 = this;
      ...
      return (0, _keys["default"])(fields).map(function (fieldKey) {
        ...
        if (items) {
          ...
          return /*#__PURE__*/_react["default"].createElement(Option, {
            ...
            label: label,
            disabled: childrenSelected && childrenSelected.keyField !== null && childrenSelected.some(function (el) {
              return el.keyField === field.path;
            }) || childrenSelected && childrenSelected.some(function (el) {
            ...
            className: icon ? 'query-builder-option-wrapper' : ''
          }, /*#__PURE__*/_react["default"].createElement("div", {
            className: icon ? 'query-builder-option-wrapper-inner' : ''
...
FieldSelect.propTypes = {
  ...
  childrenSelected: _propTypes["default"].array,
  //actions
