...
var typeMap = {
  rule: function rule(props) {
    ...
    // };
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_Rule["default"], _extends({}, props.properties.toObject(), {
      id: props.id,
      path: props.path,
  ...
  rule_group: function rule_group(props) {
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_RuleGroup["default"], _extends({}, props.properties.toObject(), {
      id: props.id,
      path: props.path,
      actions: props.actions,
      config: props.config //tree={props.tree}
      ...
      validity: props.validity,
      errorMessage: props.errorMessage
    })), /*#__PURE__*/_react["default"].createElement("span", null, props.errorMessage));
  }
};
...
Item.propTypes = {
  ...
  arrChildrenSelected: _propTypes["default"].array
};
var _default = Item;
