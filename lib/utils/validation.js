...
var getNewValueForFieldOp = function getNewValueForFieldOp(config) {
  ...
  newValue = new _immutable["default"].List(Array.from({
    ...
    if (canReuseValue) {
      ...
      if (newFieldConfig.defaultValue !== undefined && touched === false && newOperator !== 'date_range') v = newFieldConfig.defaultValue;
      if (newFieldConfig.defaultValue !== undefined && touched === false && newOperator === 'date_range') v = undefined;else if (newFieldConfig.fieldSettings && newFieldConfig.fieldSettings.defaultValue !== undefined) v = newFieldConfig.fieldSettings.defaultValue;else if (firstWidgetConfig.defaultValue !== undefined) v = firstWidgetConfig.defaultValue;
    }
