...
function validateRule(item, path, itemId, meta, c) {
  ...
  var touched = properties.get('touched');
  var oldSerialized = {
    field: field,
    operator: operator,
  ...
  var _getNewValueForFieldO = getNewValueForFieldOp(config, oldConfig, properties, field, operator, touched, null, true),
...
var validateValue = function validateValue(config, leftField, field, operator, value, valueType, valueSrc, flag, valueArr, touched) {
  var canFix = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : false;
  var isEndValue = arguments.length > 11 && arguments[11] !== undefined ? arguments[11] : false;
  var isRawValue = arguments.length > 12 && arguments[12] !== undefined ? arguments[12] : true;
  var validError = null;
  ...
  if (value != null || !value) {
    if (valueSrc == 'field') {
      ...
      var _validateFuncValue = validateFuncValue(leftField, field, value, valueSrc, valueType, config, flag, touched, operator, isEndValue, flag, canFix);
      ...
      if (funcConfig) {
        ...
        for (var argKey in funcConfig.args) {
          ...
          if (argValue !== undefined) {
            var _validateValue = validateValue(config, leftField, fieldDef, operator, argValue, argConfig.type, argValueSrc, flag, touched, canFix, Array.isArray(argValue), isEndValue, false),
...
var getNewValueForFieldOp = function getNewValueForFieldOp(config) {
  ...
  var touched = arguments.length > 5 ? arguments[5] : undefined;
  var changedField = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : null;
  var canFix = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : true;
  ...
  if (canReuseValue) {
    var _loop = function _loop(i) {
      ...
      var _validateValue3 = validateValue(config, newField, newField, newOperator, v, vType, vSrc, true, Array.isArray(v), canFix, isEndValue),
  ...
  newValue = new _immutable["default"].List(Array.from({
    ...
    if (canReuseValue) {
      ...
      if (newFieldConfig.defaultValue !== undefined && touched === false) v = newFieldConfig.defaultValue;else if (newFieldConfig.fieldSettings && newFieldConfig.fieldSettings.defaultValue !== undefined) v = newFieldConfig.fieldSettings.defaultValue;else if (firstWidgetConfig.defaultValue !== undefined) v = firstWidgetConfig.defaultValue;
    } else if (operatorCardinality == 2 && (firstWidgetConfig || newFieldConfig) && touched === false) {
      if (newFieldConfig.defaultValue !== undefined && touched === false) v = [newFieldConfig.defaultValue, newFieldConfig.defaultValue];else if (newFieldConfig.fieldSettings && newFieldConfig.fieldSettings.defaultValue !== undefined) v = [newFieldConfig.defaultValue, newFieldConfig.defaultValue];else if (firstWidgetConfig.defaultValue !== undefined) v = [firstWidgetConfig.defaultValue, firstWidgetConfig.defaultValue];
    }
