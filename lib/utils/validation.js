...
function validateRule(item, path, itemId, meta, c) {
  ...
  var validity = properties.get('validity');
  var oldSerialized = {
    field: field,
    operator: operator,
  ...
  var _getNewValueForFieldO = getNewValueForFieldOp(config, oldConfig, properties, field, operator, validity, null, true),
...
var validateValue = function validateValue(config, leftField, field, operator, value, valueType, valueSrc, flag, valueArr) {
  ...
  if (value != null || !value) {
    if (valueSrc == 'field') {
      ...
      var _validateFuncValue = validateFuncValue(leftField, field, value, valueSrc, valueType, config, flag, operator, isEndValue, flag, canFix);
      ...
      if (funcConfig) {
        ...
        for (var argKey in funcConfig.args) {
          ...
          if (argValue !== undefined) {
            var _validateValue = validateValue(config, leftField, fieldDef, operator, argValue, argConfig.type, argValueSrc, flag, canFix, Array.isArray(argValue), isEndValue, false),
...
var getNewValueForFieldOp = function getNewValueForFieldOp(config) {
  ...
  var validity = arguments.length > 5 ? arguments[5] : undefined;
  ...
  newValue = new _immutable["default"].List(Array.from({
    ...
    if (canReuseValue) {
      ...
      if (newFieldConfig.defaultValue !== undefined && validity) v = newFieldConfig.defaultValue;else if (newFieldConfig.fieldSettings && newFieldConfig.fieldSettings.defaultValue !== undefined) v = newFieldConfig.fieldSettings.defaultValue;else if (firstWidgetConfig.defaultValue !== undefined) v = firstWidgetConfig.defaultValue;
    }
