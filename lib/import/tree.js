...
exports.validateEmptyValuesTree = exports.rulesMaxNumberReached = exports.isValidTree = exports.checkTree = exports.loadTree = exports.getTree = void 0;
...
var rulesMaxNumberReached = function rulesMaxNumberReached(tree, config) {
  var properties = tree.get('properties');

  if (properties) {
    var numberOfRules = properties.get('numberOfRules');
...
exports.rulesMaxNumberReached = rulesMaxNumberReached;
