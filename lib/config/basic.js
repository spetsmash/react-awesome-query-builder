...
var types = {
  text: {
    ...
    widgets: {
      text: {
        operators: ['equal', 'not_equal', 'is_empty', 'is_not_empty', 'like', 'not_like', 'proximity', 'exists', 'not_exists'],
        widgetProps: {},
        opProps: {}
      },
      field: {
  ...
  date: {
    ...
    widgets: {
      date: {
        operators: ["equal", "not_equal", "less", "less_or_equal", "greater", "greater_or_equal", "between", "not_between", "is_empty", "is_not_empty", "date_range", "not_date_range", 'exists', 'not_exists']
      }
    }
  },
  time: {
  ...
  select: {
    ...
    widgets: {
      select: {
        operators: ['select_equals', 'select_not_equals', 'exists', 'not_exists'],
        widgetProps: {
          customProps: {
            showSearch: true
          }
      ...
      multiselect: {
        operators: ['select_any_in', 'select_not_any_in', 'exists', 'not_exists']
      }
    }
  },
  multiselect: {
