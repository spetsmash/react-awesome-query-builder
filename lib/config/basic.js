...
var types = {
  text: {
    ...
    widgets: {
      ...
      field: {
        operators: [//unary ops (like `is_empty`) will be excluded anyway, see widgetOpProps()
  ...
  date: {
    ...
    widgets: {
      date: {
        operators: ["equal", "not_equal", "less", "less_or_equal", "greater", "greater_or_equal", "between", "not_between", "is_empty", "is_not_empty", "date_range", "not_date_range"]
      }
    }
  },
  time: {
